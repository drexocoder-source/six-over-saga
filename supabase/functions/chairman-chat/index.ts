// Chairman AI — streams league-aware answers via Lovable AI Gateway.
const corsHeaders = {
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const sysPrompt = `You are the Chairman AI for an IPL-style fantasy cricket league simulator.
Use cricket terminology, be witty and concise, format with markdown.
